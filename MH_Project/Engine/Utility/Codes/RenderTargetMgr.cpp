...
void Engine::CRenderTargetMgr::Get_RenderTargetTexture(LPD3DXEFFECT& pEffect, const wstring pTargetTag, const char* pConstantTable)
{
	CRenderTarget*	pRenderTarget = Find_RenderTarget(pTargetTag);
	NULL_CHECK(pRenderTarget);

	pRenderTarget->Get_RenderTargetTexture(pEffect, pConstantTable);
