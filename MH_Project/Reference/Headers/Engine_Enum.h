...
namespace Engine
{
	...
	{ 
		...
		STATE_FURY_NO1, STATE_FURY_NO2, 
		STATE_PUSH, 
		STATE_POTION_BEGIN, STATE_POTION_DURING, 
		STATE_SP_STAND, 
		STATE_END
	};
	enum OBJECT
	{
		OBJ_PLAYER, OBJ_AHGLAN, OBJ_CLOYAN, OBJ_ENEMIES, 
		OBJ_END
	};
	enum WEAPON_MODE
	{
	...
	enum SCENE_ID
	{
		SCENE_LOGO, SCENE_LOADING, SCENE_STAGE, SCENE_STAGE_1,
		SCENE_END
	};
	enum NAMINGSCENE_ID
	{
	...
	enum BUFF_ID
	{
		BUFF_CRITICAL, BUFF_STAMINA, BUFF_REINFORCE, 
		BUFF_END
	};
	enum DAMAGEFONT_ID
	{
	...
	enum POTION_TYPE
	{
		POTION_HP, POTION_STEMINA, POTION_SP, 
		POTION_END
	};
	...
	enum RENDERID { RENDER_PRIORITY, RENDER_NONALPHA, RENDER_ALPHA, RENDER_ALPHA2, RENDER_UI, RENDER_END};
