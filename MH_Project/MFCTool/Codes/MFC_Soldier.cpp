...
CMFC_Soldier::CMFC_Soldier(LPDIRECT3DDEVICE9 pGraphicDev)
	: CGameObject(pGraphicDev)
{
}

CMFC_Soldier::~CMFC_Soldier()
{
}


HRESULT CMFC_Soldier::Ready_Object(void)
{
...
_int CMFC_Soldier::Update_Object(const _float & fTimeDelta)
{
...
void CMFC_Soldier::Render_Object(void)
{
...
HRESULT CMFC_Soldier::Add_Component(void)
{
	CComponent*		pComponent = nullptr;

	// DynamicMesh
	pComponent = m_pMeshCom = dynamic_cast<CDynamicMesh*>(Clone_Prototype(L"Proto_DynamicMesh_Soldier"));
...
HRESULT CMFC_Soldier::SetUp_ConstantTable(LPD3DXEFFECT & pEffect)
{
...
void CMFC_Soldier::Key_Input(const _float & fTimeDelta)
{
...
HRESULT CMFC_Soldier::Add_Collider(_float fRadius, wstring cstrName, const _matrix* pColliderMatrix, COLLIDERTYPE eColliderType)
{
...
HRESULT CMFC_Soldier::Add_Collider(_float vMinX, _float vMinY, _float vMinZ, _float vMaxX, _float vMaxY, _float vMaxZ, wstring wstrName, const _matrix* pColliderMatrix, COLLIDERTYPE eColliderType)
{
...
HRESULT CMFC_Soldier::Delete_Collider(wstring wstrName, COLLIDERTYPE eColliderType)
{
...
HRESULT CMFC_Soldier::Change_ColliderScale(_float fRadius, wstring cstrName)
{
...
CMFC_Soldier * CMFC_Soldier::Create(LPDIRECT3DDEVICE9 pGraphicDev)
{
	CMFC_Soldier* pInstance = new CMFC_Soldier(pGraphicDev);
