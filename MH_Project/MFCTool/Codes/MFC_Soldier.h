...
class CMFC_Soldier : public CGameObject
{
private:
	explicit CMFC_Soldier(LPDIRECT3DDEVICE9 pGraphicDev);
	virtual ~CMFC_Soldier();
...
public:
	static	CMFC_Soldier*	Create(LPDIRECT3DDEVICE9 pGraphicDev);
	virtual void			Free();
};
