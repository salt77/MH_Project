...
CMFC_Knight::CMFC_Knight(LPDIRECT3DDEVICE9 pGraphicDev)
	: CGameObject(pGraphicDev)
{
}

CMFC_Knight::~CMFC_Knight()
{
}


HRESULT CMFC_Knight::Ready_Object(void)
{
...
_int CMFC_Knight::Update_Object(const _float & fTimeDelta)
{
...
void CMFC_Knight::Render_Object(void)
{
...
HRESULT CMFC_Knight::Add_Component(void)
{
	CComponent*		pComponent = nullptr;

	// DynamicMesh
	pComponent = m_pMeshCom = dynamic_cast<CDynamicMesh*>(Clone_Prototype(L"Proto_DynamicMesh_Knight"));
...
HRESULT CMFC_Knight::SetUp_ConstantTable(LPD3DXEFFECT & pEffect)
{
...
void CMFC_Knight::Key_Input(const _float & fTimeDelta)
{
...
HRESULT CMFC_Knight::Add_Collider(_float fRadius, wstring cstrName, const _matrix* pColliderMatrix, COLLIDERTYPE eColliderType)
{
...
HRESULT CMFC_Knight::Add_Collider(_float vMinX, _float vMinY, _float vMinZ, _float vMaxX, _float vMaxY, _float vMaxZ, wstring wstrName, const _matrix* pColliderMatrix, COLLIDERTYPE eColliderType)
{
...
HRESULT CMFC_Knight::Delete_Collider(wstring wstrName, COLLIDERTYPE eColliderType)
{
...
HRESULT CMFC_Knight::Change_ColliderScale(_float fRadius, wstring cstrName)
{
...
CMFC_Knight * CMFC_Knight::Create(LPDIRECT3DDEVICE9 pGraphicDev)
{
	CMFC_Knight* pInstance = new CMFC_Knight(pGraphicDev);
