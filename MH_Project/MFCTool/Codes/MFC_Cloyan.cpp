...
CMFC_Cloyan::CMFC_Cloyan(LPDIRECT3DDEVICE9 pGraphicDev)
	: CGameObject(pGraphicDev)
{
}

CMFC_Cloyan::~CMFC_Cloyan()
{
}


HRESULT CMFC_Cloyan::Ready_Object(void)
{
...
_int CMFC_Cloyan::Update_Object(const _float & fTimeDelta)
{
...
void CMFC_Cloyan::Render_Object(void)
{
...
HRESULT CMFC_Cloyan::Add_Component(void)
{
	CComponent*		pComponent = nullptr;

	// DynamicMesh
	pComponent = m_pMeshCom = dynamic_cast<CDynamicMesh*>(Clone_Prototype(L"Proto_DynamicMesh_Cloyan"));
...
HRESULT CMFC_Cloyan::SetUp_ConstantTable(LPD3DXEFFECT & pEffect)
{
...
void CMFC_Cloyan::Key_Input(const _float & fTimeDelta)
{
...
HRESULT CMFC_Cloyan::Add_Collider(_float fRadius, wstring cstrName, const _matrix* pColliderMatrix, COLLIDERTYPE eColliderType)
{
...
HRESULT CMFC_Cloyan::Add_Collider(_float vMinX, _float vMinY, _float vMinZ, _float vMaxX, _float vMaxY, _float vMaxZ, wstring wstrName, const _matrix* pColliderMatrix, COLLIDERTYPE eColliderType)
{
...
HRESULT CMFC_Cloyan::Delete_Collider(wstring wstrName, COLLIDERTYPE eColliderType)
{
...
HRESULT CMFC_Cloyan::Change_ColliderScale(_float fRadius, wstring cstrName)
{
...
CMFC_Cloyan * CMFC_Cloyan::Create(LPDIRECT3DDEVICE9 pGraphicDev)
{
	CMFC_Cloyan* pInstance = new CMFC_Cloyan(pGraphicDev);
