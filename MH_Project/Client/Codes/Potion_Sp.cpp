...
CPotion_Sp::CPotion_Sp(LPDIRECT3DDEVICE9 pGraphicDev)
	: CSlot_ItemSkill(pGraphicDev)
{
}

CPotion_Sp::~CPotion_Sp()
{
}


HRESULT CPotion_Sp::Ready_Object(_float fX, _float fY, _float fSizeX, _float fSizeY)
{
	...
	m_fValueRatio = 0.9f;
	m_fCoolDownDelay = 0.07f;

	return S_OK;
}

HRESULT CPotion_Sp::LateReady_Object()
{
...
_int CPotion_Sp::Update_Object(const _float& fTimeDelta)
{
...
_int CPotion_Sp::LateUpdate_Object(const _float & fTimeDelta)
{
...
CPotion_Sp* CPotion_Sp::Create(LPDIRECT3DDEVICE9 pGraphicDev, _float fX, _float fY, _float fSizeX, _float fSizeY)
{
	CPotion_Sp*	pInstance = new CPotion_Sp(pGraphicDev);
...
void CPotion_Sp::Free()
{
	CSlot_ItemSkill::Free();
}

HRESULT CPotion_Sp::Add_Component()
{
	...
	// texture
	pComponent = m_pTextureCom = dynamic_cast<CTexture*>(Clone_Prototype(L"Proto_Texture_Potion_Sp"));
...
HRESULT CPotion_Sp::SetUp_ConstantTable(LPD3DXEFFECT & pEffect)
{
