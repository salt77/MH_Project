...
class CTooltip_Reinforce final : public CUI
{
private:
	explicit CTooltip_Reinforce(LPDIRECT3DDEVICE9 pGraphicDev);
	virtual ~CTooltip_Reinforce();
...
public:
	static CTooltip_Reinforce*	Create(LPDIRECT3DDEVICE9 pGraphicDev, _float fX, _float fY, _float fSizeX, _float fSizeY);
	virtual void				Free();
};
