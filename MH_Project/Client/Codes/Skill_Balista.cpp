...
CSkill_Balista::CSkill_Balista(LPDIRECT3DDEVICE9 pGraphicDev)
	: CSlot_ItemSkill(pGraphicDev)
{
}

CSkill_Balista::~CSkill_Balista()
{
}


HRESULT CSkill_Balista::Ready_Object(_float fX, _float fY, _float fSizeX, _float fSizeY)
{
...
HRESULT CSkill_Balista::LateReady_Object()
{
...
_int CSkill_Balista::Update_Object(const _float& fTimeDelta)
{
...
_int CSkill_Balista::LateUpdate_Object(const _float & fTimeDelta)
{
...
void CSkill_Balista::Render_Object()
{
...
CSkill_Balista* CSkill_Balista::Create(LPDIRECT3DDEVICE9 pGraphicDev, _float fX, _float fY, _float fSizeX, _float fSizeY)
{
	CSkill_Balista*	pInstance = new CSkill_Balista(pGraphicDev);
...
void CSkill_Balista::Free()
{
	CSlot_ItemSkill::Free();
}

HRESULT CSkill_Balista::Add_Component()
{
	...
	// texture
	pComponent = m_pTextureCom = dynamic_cast<CTexture*>(Clone_Prototype(L"Proto_Texture_Skill_Balista"));
...
HRESULT CSkill_Balista::SetUp_ConstantTable(LPD3DXEFFECT & pEffect)
{
...
void CSkill_Balista::Cool_Down(const _float & fTimeDelta)
{
	if (m_bReadyToFire)
	{
		if (!m_bCanUse)
