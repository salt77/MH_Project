...
CAhglan_FontName::CAhglan_FontName(LPDIRECT3DDEVICE9 pGraphicDev)
	: CUI(pGraphicDev)
{
}

CAhglan_FontName::~CAhglan_FontName(void)
{
}
...
_int CAhglan_FontName::Update_Object(const _float& fTimeDelta)
{
...
void CAhglan_FontName::Render_Object(void)
{
...
void CAhglan_FontName::Free(void)
{
	CUI::Free();
}

HRESULT CAhglan_FontName::Add_Component(void)
{
...
HRESULT CAhglan_FontName::SetUp_ConstantTable(LPD3DXEFFECT & pEffect)
{
