...
CSkill_Sp_Stand::CSkill_Sp_Stand(LPDIRECT3DDEVICE9 pGraphicDev)
	: CSlot_ItemSkill(pGraphicDev)
{
}

CSkill_Sp_Stand::~CSkill_Sp_Stand()
{
}


HRESULT CSkill_Sp_Stand::Ready_Object(_float fX, _float fY, _float fSizeX, _float fSizeY)
{
...
HRESULT CSkill_Sp_Stand::LateReady_Object()
{
...
_int CSkill_Sp_Stand::Update_Object(const _float& fTimeDelta)
{
...
_int CSkill_Sp_Stand::LateUpdate_Object(const _float & fTimeDelta)
{
...
void CSkill_Sp_Stand::Render_Object()
{
...
CSkill_Sp_Stand* CSkill_Sp_Stand::Create(LPDIRECT3DDEVICE9 pGraphicDev, _float fX, _float fY, _float fSizeX, _float fSizeY)
{
	CSkill_Sp_Stand*	pInstance = new CSkill_Sp_Stand(pGraphicDev);
...
void CSkill_Sp_Stand::Free()
{
	CSlot_ItemSkill::Free();
}

HRESULT CSkill_Sp_Stand::Add_Component()
{
	...
	// texture
	pComponent = m_pTextureCom = dynamic_cast<CTexture*>(Clone_Prototype(L"Proto_Texture_Sp_Reinforce"));
...
HRESULT CSkill_Sp_Stand::SetUp_ConstantTable(LPD3DXEFFECT & pEffect)
{
