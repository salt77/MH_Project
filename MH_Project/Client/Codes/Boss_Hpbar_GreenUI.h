...
class CBoss_Hpbar_GreenUI final : public CUI
{
private:
	explicit CBoss_Hpbar_GreenUI(LPDIRECT3DDEVICE9 pGraphicDev);
	virtual ~CBoss_Hpbar_GreenUI(void);
...
public:
	static CBoss_Hpbar_GreenUI*	Create(LPDIRECT3DDEVICE9 pGraphicDev, _float fX, _float fY, _float fSizeX, _float fSizeY, _int iHpType);
