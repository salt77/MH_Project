...
CBoss_Hpbar_RedUI::CBoss_Hpbar_RedUI(LPDIRECT3DDEVICE9 pGraphicDev)
	: CUI(pGraphicDev)
{
}

CBoss_Hpbar_RedUI::~CBoss_Hpbar_RedUI(void)
{
}


HRESULT CBoss_Hpbar_RedUI::Ready_Object(_float fX, _float fY, _float fSizeX, _float fSizeY, _int iHpType)
{
...
_int CBoss_Hpbar_RedUI::Update_Object(const _float& fTimeDelta)
{
...
void CBoss_Hpbar_RedUI::Render_Object(void)
{
...
CBoss_Hpbar_RedUI* CBoss_Hpbar_RedUI::Create(LPDIRECT3DDEVICE9 pGraphicDev, _float fX, _float fY, _float fSizeX, _float fSizeY, _int iHpType)
{
	CBoss_Hpbar_RedUI*	pInstance = new CBoss_Hpbar_RedUI(pGraphicDev);
...
void CBoss_Hpbar_RedUI::Free(void)
{
	CUI::Free();
}

HRESULT CBoss_Hpbar_RedUI::Add_Component(void)
{
	...
	// texture
	pComponent = m_pTextureCom = dynamic_cast<CTexture*>(Clone_Prototype(L"Proto_Texture_Boss_Hpbar_RedUI"));
...
HRESULT CBoss_Hpbar_RedUI::SetUp_ConstantTable(LPD3DXEFFECT & pEffect)
{
