...
class CTrail_Smash final : public CGameObject
{
private:
	explicit CTrail_Smash(LPDIRECT3DDEVICE9 pGraphicDev);
	virtual ~CTrail_Smash(void);
...
private:
	...
	CSmashTrail*			m_pTrailCom = nullptr;
	CTexture*		m_pTextureCom = nullptr;

public:
	static CTrail_Smash*	Create(LPDIRECT3DDEVICE9 pGraphicDev);
