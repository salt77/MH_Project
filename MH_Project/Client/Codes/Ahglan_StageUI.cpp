...
CAhglan_StageUI::CAhglan_StageUI(LPDIRECT3DDEVICE9 pGraphicDev)
	: CUI(pGraphicDev)
{
}

CAhglan_StageUI::~CAhglan_StageUI(void)
{
}
...
_int CAhglan_StageUI::Update_Object(const _float& fTimeDelta)
{
...
void CAhglan_StageUI::Render_Object(void)
{
...
HRESULT CAhglan_StageUI::SetUp_ConstantTable(LPD3DXEFFECT & pEffect)
{
