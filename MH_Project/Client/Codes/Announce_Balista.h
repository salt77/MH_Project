...
class CAnnounce_Balista final : public CUI
{
private:
	explicit CAnnounce_Balista(LPDIRECT3DDEVICE9 pGraphicDev);
	virtual ~CAnnounce_Balista(void);
...
public:
	static CAnnounce_Balista*	Create(LPDIRECT3DDEVICE9 pGraphicDev, _float fX, _float fY, _float fSizeX, _float fSizeY);
	virtual void				Free();
};
