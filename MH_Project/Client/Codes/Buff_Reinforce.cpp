...
CBuff_Reinforce::CBuff_Reinforce(LPDIRECT3DDEVICE9 pGraphicDev)
	: CBuff_Player(pGraphicDev)
{
}

CBuff_Reinforce::~CBuff_Reinforce()
{
}


HRESULT CBuff_Reinforce::Ready_Object(_float fX, _float fY, _float fSizeX, _float fSizeY)
{
...
HRESULT CBuff_Reinforce::LateReady_Object()
{
...
_int CBuff_Reinforce::Update_Object(const _float & fTimeDelta)
{
...
_int CBuff_Reinforce::LateUpdate_Object(const _float & fTimeDelta)
{
...
void CBuff_Reinforce::Render_Object()
{
	if (m_bBuffOn)
	{
...
HRESULT CBuff_Reinforce::Add_Component()
{
	...
	// texture
	pComponent = m_pTextureCom = dynamic_cast<CTexture*>(Clone_Prototype(L"Proto_Texture_Buff_Reinforce"));
...
HRESULT CBuff_Reinforce::SetUp_ConstantTable(LPD3DXEFFECT & pEffect)
{
...
CBuff_Reinforce * CBuff_Reinforce::Create(LPDIRECT3DDEVICE9 pGraphicDev, _float fX, _float fY, _float fSizeX, _float fSizeY)
{
	CBuff_Reinforce*	pInstance = new CBuff_Reinforce(pGraphicDev);
