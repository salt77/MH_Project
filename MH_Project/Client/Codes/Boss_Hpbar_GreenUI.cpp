...
CBoss_Hpbar_GreenUI::CBoss_Hpbar_GreenUI(LPDIRECT3DDEVICE9 pGraphicDev)
	: CUI(pGraphicDev)
{
}

CBoss_Hpbar_GreenUI::~CBoss_Hpbar_GreenUI(void)
{
}


HRESULT CBoss_Hpbar_GreenUI::Ready_Object(_float fX, _float fY, _float fSizeX, _float fSizeY, _int iHpType)
{
...
_int CBoss_Hpbar_GreenUI::Update_Object(const _float& fTimeDelta)
{
...
void CBoss_Hpbar_GreenUI::Render_Object(void)
{
...
CBoss_Hpbar_GreenUI* CBoss_Hpbar_GreenUI::Create(LPDIRECT3DDEVICE9 pGraphicDev, _float fX, _float fY, _float fSizeX, _float fSizeY, _int iHpType)
{
	CBoss_Hpbar_GreenUI*	pInstance = new CBoss_Hpbar_GreenUI(pGraphicDev);
...
void CBoss_Hpbar_GreenUI::Free(void)
{
	CUI::Free();
}

HRESULT CBoss_Hpbar_GreenUI::Add_Component(void)
{
	...
	// texture
	pComponent = m_pTextureCom = dynamic_cast<CTexture*>(Clone_Prototype(L"Proto_Texture_Boss_Hpbar_GreenUI"));
...
HRESULT CBoss_Hpbar_GreenUI::SetUp_ConstantTable(LPD3DXEFFECT & pEffect)
{
