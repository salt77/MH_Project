...
CPotion_Stemina::CPotion_Stemina(LPDIRECT3DDEVICE9 pGraphicDev)
	: CSlot_ItemSkill(pGraphicDev)
{
}

CPotion_Stemina::~CPotion_Stemina()
{
}


HRESULT CPotion_Stemina::Ready_Object(_float fX, _float fY, _float fSizeX, _float fSizeY)
{
...
HRESULT CPotion_Stemina::LateReady_Object()
{
...
_int CPotion_Stemina::Update_Object(const _float& fTimeDelta)
{
...
_int CPotion_Stemina::LateUpdate_Object(const _float & fTimeDelta)
{
...
void CPotion_Stemina::Render_Object()
{
...
CPotion_Stemina* CPotion_Stemina::Create(LPDIRECT3DDEVICE9 pGraphicDev, _float fX, _float fY, _float fSizeX, _float fSizeY)
{
	CPotion_Stemina*	pInstance = new CPotion_Stemina(pGraphicDev);
...
void CPotion_Stemina::Free()
{
	CSlot_ItemSkill::Free();
}

HRESULT CPotion_Stemina::Add_Component()
{
	...
	// texture
	pComponent = m_pTextureCom = dynamic_cast<CTexture*>(Clone_Prototype(L"Proto_Texture_Potion_Stemina"));
...
HRESULT CPotion_Stemina::SetUp_ConstantTable(LPD3DXEFFECT & pEffect)
{
